...
> [!IMPORTANT]
> This repository is deprecated. Development moved to
> [`soundkit/soundkit-opus/libopus-rs`](https://github.com/wavey-ai/soundkit/tree/main/soundkit-opus/libopus-rs).
> Use the SoundKit repository for issues, pull requests, and new releases.
